...
namespace DoctrineProxies\__CG__\EdtfDataType\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class EdtfDataTypeEdtf extends \EdtfDataType\Entity\EdtfDataTypeEdtf implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EdtfDataTypeEdtf $proxy) {
