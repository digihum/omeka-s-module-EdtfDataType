...
class DateBefore implements FacetTypeInterface
{
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-data-form/date-before.js', 'EdtfDataType'));
    }
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-render/date-before.js', 'EdtfDataType'));
    }
