...
class DurationLessThan implements FacetTypeInterface
{
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-data-form/duration-less-than.js', 'EdtfDataType'));
    }
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-render/duration-less-than.js', 'EdtfDataType'));
    }
