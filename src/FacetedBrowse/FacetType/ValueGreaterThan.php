...
class ValueGreaterThan implements FacetTypeInterface
{
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-data-form/value-greater-than.js', 'EdtfDataType'));
    }
    ...
    {
        $view->headScript()->appendFile($view->assetUrl('js/faceted-browse/facet-render/value-greater-than.js', 'EdtfDataType'));
    }
